...
describe("Git file path contracts", () => {
  it("preserves History file-path whitespace while trimming existing VCS paths", () => {
...
describe("Git history results", () => {
  ...
  it("requires a History ref kind", () => {
    expect(() =>
      decodeListHistoryRefsResult({
        refs: [
          {
            name: "main",
            current: true,
