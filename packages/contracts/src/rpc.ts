...
const WsVcsListHistoryRefsRpc = Rpc.make(WS_METHODS.vcsListHistoryRefs, {
...
const WsVcsGetHistoryRpc = Rpc.make(WS_METHODS.vcsGetHistory, {
  payload: VcsGetHistoryInput,
  success: VcsGetHistoryResult,
  error: Schema.Union([GitCommandError, VcsSnapshotExpiredError, EnvironmentAuthorizationError]),
});

const WsVcsGetCommitDetailsRpc = Rpc.make(WS_METHODS.vcsGetCommitDetails, {
  payload: VcsGetCommitDetailsInput,
  success: VcsGetCommitDetailsResult,
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});

const WsVcsListCommitFilesRpc = Rpc.make(WS_METHODS.vcsListCommitFiles, {
  payload: VcsListCommitFilesInput,
  success: VcsListCommitFilesResult,
  error: Schema.Union([GitCommandError, VcsSnapshotExpiredError, EnvironmentAuthorizationError]),
});

const WsVcsGetCommitDiffRpc = Rpc.make(WS_METHODS.vcsGetCommitDiff, {
