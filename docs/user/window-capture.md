...
On Linux, the full window-to-composer effect requires the current T3 Code GNOME extension.
GNOME renders it directly; the portal and picker paths use a short composer arrival effect instead. After updating an older extension,
