...
4. Commit as usual. **Push** and **Create pull request** become **Submit stack** and update every
   step together.
...
**Merge stack** merges the selected step and each open step below it. **Merge only this PR** remains
available in the extra actions menu.
