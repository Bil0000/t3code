...
export const PREVIEW_SET_DESIGN_EDITING_CHANNEL = "desktop:preview-set-design-editing";
...
export const PREVIEW_DESIGN_CHANGE_CHANNEL = "desktop:preview-design-change";
