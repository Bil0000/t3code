...
import { captureNiriWindow, checkNiriCaptureSupport, niriSocketPath } from "./NiriWindowCapture.ts";
import { captureLinuxWindow, getLinuxCaptureSupport } from "./LinuxWindowCapture.ts";
