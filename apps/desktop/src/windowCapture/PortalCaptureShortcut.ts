...
import type { WindowCaptureKeyChord } from "@t3tools/contracts";
...
export function portalShortcutTrigger(shortcut: WindowCaptureKeyChord): string {
...
export class PortalCaptureShortcut {
  ...
  private async initialize(appId: string, shortcut: WindowCaptureKeyChord) {
