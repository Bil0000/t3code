        ...
        for (const item of pending) {
          ...
          try {
            ...
            const dataUrl = compressed.recompressed
              ...
              : capture.dataUrl;
            const shouldAnimate =
              animateCaptures && !window.matchMedia("(prefers-reduced-motion: reduce)").matches;
            if (shouldAnimate) beginWindowCaptureAnimation(capture.id);
            ...
            if (shouldAnimate) {
              ...
              await waitForWindowCaptureAnimationDestination(capture.id);
            ...
            dismissWindowCaptureAnimation(item.id);
            toastManager.add(
              stackedThreadToast({
                type: "error",
