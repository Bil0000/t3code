...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.issueTrackersConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.issueTrackersDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.issueTrackersBind]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.workItemsLink]: AuthOrchestrationOperateScope,
  [WS_METHODS.workItemsUnlink]: AuthOrchestrationOperateScope,
